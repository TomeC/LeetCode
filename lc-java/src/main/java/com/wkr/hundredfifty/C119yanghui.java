...
public class C119yanghui {
    ...
    public static void main(String[] args) {
        ...
        Utils.listEqual(yanghui.getRow(1), Arrays.asList(1,1), "1");
        Utils.listEqual(yanghui.getRow(2), Arrays.asList(1,2,1), "2");
        Utils.listEqual(yanghui.getRow(3), Arrays.asList(1,3,3,1), "3");
    }
